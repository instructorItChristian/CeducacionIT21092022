...
public class laboratorio6 {
	...
	String docPath="..\\CeducacionIT21092022\\Evidencias\\documentoEvidencias.docx";
	WebDriver driver;
	File screen;
	...
	public void irAContacUs() throws InvalidFormatException, IOException, InterruptedException  {
		...
		CapturaEvidencia.escribirTituloEnDocumento(docPath, "documento de captura evidencias CP-002 - ir a contact US", 18);
		...
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath, "formulario a completar");
		...
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath +"img.jpg", docPath, "respuesta a la carga");
